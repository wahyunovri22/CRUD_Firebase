...
import com.example.cia.esuratuser.Activity.DetailRtActivity;
...
public class RecyclerViewLihatKtp extends RecyclerView.Adapter<RecyclerViewLihatKtp.dataViewHolder> {

    List<AddKtp> addKtps;
    private Context context;

    public RecyclerViewLihatKtp(List<AddKtp> addKtps, Context context) {
    ...
    public dataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerViewLihatKtp.dataViewHolder holder = new RecyclerViewLihatKtp.dataViewHolder(view);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(context, DetailRtActivity.class);
