...
import com.example.cia.esuratuser.Activity.LihatSuratActivity;
import com.example.cia.esuratuser.Activity.LihatWargaActivity;
import com.example.cia.esuratuser.R;
import com.example.cia.esuratuser.helper.Config;

import java.util.HashMap;

public class HomeRTActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ImageView imgLihatWarga,imgLihatKtp;
    private SliderLayout mDemoSlider;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home_rt2);
        ...
        imgLihatWarga = (ImageView)findViewById(R.id.img_lihat_warga);
        imgLihatKtp = (ImageView)findViewById(R.id.img_lihat_surat);

        imgLihatWarga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(HomeRTActivity.this, LihatWargaActivity.class);
                startActivity(i);
                startActivity(i);
            }
        });

        imgLihatKtp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(HomeRTActivity.this, LihatSuratActivity.class);
                startActivity(i);
                startActivity(i);
            }
        });
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_rt, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.lihatWarga) {
            // TODO Code Somthing
        } else if (id == R.id.lihatSurat) {
            // TODO Code Somthing
